...
class CreateBuyClassGroupValuesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('buy_class_group_values', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('buy_class_group_values');
    }
}
