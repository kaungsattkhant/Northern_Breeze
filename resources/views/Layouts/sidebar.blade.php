<div class="sidebar-nb-mount shadow mr-0">
    <ul class="nav flex-column mr-0 pt-3" id="myDIV" style="position: relative;">
        <li class="nav-item dropdown btn-mount mx-auto ">
        ...
        <li class="nav-item btn-mount mx-auto active2">
            <a class="nav-link p-0  sidebar-box-mount img-member text-center active-m" href="{{url('member')}}">
