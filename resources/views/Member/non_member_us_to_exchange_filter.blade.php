    ...
    <tr id="from">
        ...
        <td class="text-right border-top-0 pt-4 pb-4">
            ...
            @foreach($classification as $c)
                <input type="hidden" name="to_classification_id[]" value="{{$c->id}}">
                <input type="hidden" name="to_class_note_id[]" value="{{$note->id}}">
                <input type="hidden" name="to_class_group_id[]" value="{{$note->group_id}}">
                <input type="text" name="to_classification_{{$note->id}}[]" placeholder="Class" class="border rounded-table-mount w-25 text-center fontsize-mount3 pt-1 ">
                <br>
            @endforeach
        </td>
    </tr>
