...
<!--                    <p class="total-text-mount pl-5 mb-1">wrong</p>-->
                    <span class="text-danger mb-1">{{exceed_msg}}</span>
<!--                    <br>-->
                    <span class="text-danger mb-1">{{sell_not_enough_msg}}</span>
                </td>
            </tr>
                ...
                <td class="text-nb-mount border-top-0 pl-4 pt-3 justify-content-between fontsize-mount2"
                    ...
                    <div class="input-group-box">
                        ...
                        <input v-if="data.class" type="number" min="0" :max="note.class_sheet[k].sheet"
                               ...
                               :placeholder=" data.class[k].name"
                               :title="data.class[k].name"
